...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title"> Modifier une classe </h3>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('classe.update', $classe->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputName1"
                                    placeholder="Nom de la classe" name="nom_classe" value={{ $classe->nom_classe }}>
                            </div>
