...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title"> Créer un nouvel trimestre. </h3>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('trimestre.store') }}">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword4"
                                    placeholder="Entrer le trimestre" name="nom" value={{ old('nom') }}>
                            </div>
