...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title"> Modifier une année académique. </h3>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST"
                            action="{{ route('annee.update', $annee_academique->id) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword4"
                                    ...
                                    name="annee" value="{{ $annee_academique->annee }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date_debut" class="form-control" id="date_fin" placeholder=""
                                    value="{{ $annee_academique->date_debut->format('Y-m-d') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="date_fin" class="form-control" id="date_fin" placeholder=""
                                    value="{{ $annee_academique->date_fin->format('Y-m-d') }}">
                            </div>
