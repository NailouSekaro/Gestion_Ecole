...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Listes des élèves</h3>
                                    ...
                                    @forelse ($inscriptions as $inscription)
                                        <tr>
                                            ...
                                            @if ($inscription->eleve->photo)
                                                {{-- <td>
                                                    <img src="{{ Storage::url($inscription->eleve->photo) ?: asset('assets/images/faces/default-avatar.jpg') }}"
                                                        alt="Photo de l'élève" width="150" height="150">
                                                </td> --}}
                                                <td>
                                                    @if (!empty($inscription->eleve->photo))
                                                        <img src="{{ asset('storage/' . $inscription->eleve->photo) }}"
                                                            alt="Photo de l'élève" width="150" height="150">
                                                    @else
                                                        <img src="{{ asset('assets/images/faces/default-avatar.jpg') }}"
                                                            alt="Photo de l'élève" width="150" height="150">
                                                    @endif
                                                </td>
                                            @else
