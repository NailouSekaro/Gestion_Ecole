...
@section('content')
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title"> Inscrire un nouveau élève </h3>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('eleve.store') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="contact_parent" class="form-control" id="exampleInputCity1"
                                    placeholder="Entrer le contact" oninput="limiterChiffres(this,10)"
